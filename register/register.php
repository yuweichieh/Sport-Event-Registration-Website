        ...
        <div class="container">
            <div class="regist_box">
                <form action="./register.php" method="post">
                    ...
                    <b>確認密碼</b><br>
                    <input type="password" name="password_chk" placeholder="Enter your password again"><br>
                    <!-- 驗證碼未完成 -->
                    <b>驗證碼</b><br>
                    <input type="password" name="password_chk" placeholder="Calculate the answer of following image"><br>
